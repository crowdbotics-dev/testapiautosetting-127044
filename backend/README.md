...
## Project Structure
    ...
    ├── testapiautosetting_127044  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127044`
...
2. Clone this repo and `cd testapiautosetting_127044`
